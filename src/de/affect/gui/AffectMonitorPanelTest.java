 ...
 * @version 2.0
 */
public class AffectMonitorPanelTest extends JPanel implements ComponentListener {
  ...
  public AffectMonitorPanelTest(EmotionMaintainerNotifier affectMonitor, String character, EmotionVector vec, Mood currentMood) {
    ...
    //moodCubePanel.setMinimumSize(new Dimension(500,300));
    ...
    MoodCube moodDisplay = new MoodCube(character,moodCubePanel);
